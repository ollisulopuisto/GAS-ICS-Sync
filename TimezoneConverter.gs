function IsWindowsTimezone(timezone){
...
function WindowsToIANA(timezone, countryCode){
  if (countryCode != null){
    for (var i = 0; i < timezones.length; i++){
      if (timezones[i][0] == timezone && timezones[i][1] == countryCode)
...
["Turkey Standard Time","CY","Asia/Famagusta"],
